...
public:
	...
	int32_t	addr()		{ return address; }
	int32_t	end_addr()	{ return endaddress; }
protected:
	int32_t		address;		///< -1 = invalid, +ve or 0 is an address
	int32_t		endaddress;		///< -1 = invalid, +ve or 0 is an address
	string		filename;
	string		function;
	int			line_num;
	TYPE		spec_type;
